...
/* -------------------------------------------------------------------------- */
    ...
    @IBAction func guessButton(_ sender: UIButton) {
        ...
        guessedNumberLabel.text = userGuessTextField.text
        
        let guessedNumber = Int(guessedNumberLabel.text!)
        ...
        if (guessedNumber! > randNum) {
            ...
            if (guessedNumber! < randNum) {
                ...
                let alert = UIAlertController(title: "Correct!",
                                  message: "It only too you \(tries) guesses",
    ...
    @IBAction func setupGame() {
        ...
        randomNumberLabel.text = String(randNum);
    }
